...
class Solution {
    public static int findLargestSum(Node root) {
        // code here
        ...
        leftSum =  findLargestSum(root.left);
        rightSum = findLargestSum(root.right);
        return Math.max(curr, root.data+leftSum+rightSum);
    }
